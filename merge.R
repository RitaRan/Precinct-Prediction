...
# Gain the address and geometry, the longitude and latitude
pluto = st_read("/data/nyc_parking/pluto_manhattan/MNMapPLUTO.shp") %>%
  select(Address, geometry)
## unlist the geometry data in the pluto table, and gain the longitude and latitude separately
pluto_xy = cbind(
...
## Gain the data of address and precincts in Manhattan
nyc_man = nyc %>%
...
## Data Cleanup
## Further explanation in the hw6.rmd file
